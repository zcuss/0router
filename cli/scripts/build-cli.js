...
console.log("📦 Building 0Router CLI package with Next.js...\n");
...
// Strip better-sqlite3 (native) — it lives in ~/.0Router/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.0Router/runtime)");
}
console.log("");

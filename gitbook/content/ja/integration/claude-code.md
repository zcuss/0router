...
0RouterをClaude Code CLIと統合し、AnthropicのAPIリクエストを0Routerのインテリジェントルーティングシステム経由でルーティングします。
...
Claude Codeは0Routerモデルにマッピングされる以下のモデルエイリアスをサポート:

...
Preguntas comunes sobre 0Router.

---

## ¿Qué es 0Router?

**0Router es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**0Router usa una estrategia de precios de 3 niveles:**
...
**Sí, 0Router en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de 0Router.**
...
**0Router rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar 0Router?

**¡Sí! 0Router soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.0Router`)
...
**Sí, 0Router prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.0Router` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de 0Router
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/decolua/0Router/blob/main/CHANGELOG.md)
- Respalda `~/.0Router` antes de actualizaciones mayores
...
Consulta [CONTRIBUTING.md](https://github.com/decolua/0Router/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [0Router.com/docs](https://0Router.com/docs)

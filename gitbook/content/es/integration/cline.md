...
Integra 0Router con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de 0Router.
...
Establece la URL base a tu endpoint de 0Router:
...
**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de 0Router
...
4. Cline usará 0Router para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando 0Router
...
3. Obtén explicaciones potenciadas por IA a través de 0Router

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará 0Router para entender el contexto y hacer cambios
...
2. Verifica que tu instancia de 0Router esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de 0Router para cualquier error
...
1. En la configuración de Cline, establece Base URL a: `https://0Router.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de 0Router
...
## Integración con características de 0Router

### Enrutamiento de modelos

0Router enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, 0Router automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de 0Router:

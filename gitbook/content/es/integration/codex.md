...
Integra 0Router con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de 0Router.
...
0Router proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de 0Router
...
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de 0Router

...
将 0Router 与 Continue 扩展集成,直接在 Visual Studio Code 中获得 AI 协助。

## 前置要求

- 已安装 Visual Studio Code
- 从 VSCode 市场安装了 Continue 扩展
- 来自 [仪表盘](https://0Router.com/dashboard) 的 0Router API key
- 0Router 正在运行(本地或云端)
...
### 模型无响应
- 确认 0Router 正在运行:`curl http://localhost:20128/health`

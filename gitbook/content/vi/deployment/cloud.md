...
Triển khai 0Router trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.0Router` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/0Router`:

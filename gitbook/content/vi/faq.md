...
Những câu hỏi phổ biến về 0Router.

---

## 0Router là gì?

**0Router là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**0Router dùng chiến lược pricing 3 tầng:**
...
## 0Router có miễn phí không?

**Có, 0Router hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của 0Router.**
...
**0Router theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host 0Router không?

**Có! 0Router hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.0Router`)
...
**Có, 0Router ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.0Router` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server 0Router
...
## Làm thế nào để cập nhật 0Router?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/0Router/blob/main/CHANGELOG.md)
- Backup `~/.0Router` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/0Router/blob/main/CONTRIBUTING.md) để biết chi tiết.

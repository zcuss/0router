...
Tích hợp 0Router với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model 0Router có sẵn:
...
### Connection Failed
- Xác minh 0Router đang chạy: `curl http://localhost:20128/health`

...
0Router tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

0Router cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến 0Router bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến 0Router
```bash
...
- Kiểm tra kết nối network đến 0Router

...
Tích hợp 0Router với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của 0Router.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model 0Router:

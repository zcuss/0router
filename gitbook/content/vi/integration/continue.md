...
Tích hợp 0Router với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- 0Router API key từ [dashboard](https://0Router.com/dashboard)
- 0Router đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra 0Router đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến 0Router

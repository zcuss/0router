...
Các vấn đề và giải pháp phổ biến khi dùng 0Router.
...
1. **Auto-refresh (mặc định):**
   0Router tự refresh tokens. Đợi 30 giây rồi thử lại.
...
1. **Kiểm tra 0Router có chạy không:**
   ```bash
   # Check process
   ps aux | grep 0Router

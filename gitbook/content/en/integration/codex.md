...
Integrate 0Router with OpenAI Codex CLI to route your OpenAI API requests through 0Router's intelligent routing system.
...
0Router provides the following Codex models:
...
1. Verify your API key is correct in 0Router dashboard
...
1. Verify the model name matches your 0Router configuration
2. Check that the OpenAI provider connection is active in 0Router dashboard
...
Make sure you have configured your API key in the 0Router cloud dashboard.

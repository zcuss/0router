...
Integrate 0Router with Cline VSCode extension to route your AI requests through 0Router's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- 0Router running locally or cloud endpoint configured
...
Set the base URL to your 0Router endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your 0Router endpoint
...
3. The key should start with `sk-0Router-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your 0Router configuration
...
4. Cline will use 0Router to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using 0Router
...
3. Get AI-powered explanations through 0Router

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use 0Router to understand context and make changes
...
1. Verify 0Router is running: `curl http://localhost:20128/health`
...
2. Verify your 0Router instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check 0Router logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use 0Router cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://0Router.com`
2. Make sure you have configured your API key in the 0Router cloud dashboard
...
## Integration with 0Router Features

### Model Routing

0Router automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, 0Router automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through 0Router dashboard:
- Total requests
- Token usage
- Cost per model

...
0Router is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

0Router provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to 0Router using these settings:

**Local 0Router:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any 0Router model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to 0Router
```bash
...
- Check network connection to 0Router

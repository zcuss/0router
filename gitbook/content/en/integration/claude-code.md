...
Integrate 0Router with Claude Code CLI to route your Anthropic API requests through 0Router's intelligent routing system.
...
Claude Code supports the following model aliases that map to 0Router models:

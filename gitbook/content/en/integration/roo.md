...
Integrate 0Router with Roo AI Assistant to access multiple AI models through a unified interface.
...
Choose from available 0Router models:
...
### Connection Failed
- Verify 0Router is running: `curl http://localhost:20128/health`
- Check API key is correct
- Ensure Base URL includes `/v1` suffix

### Model Not Available
- Check model name matches exactly (case-sensitive)
- Verify model is enabled in your 0Router plan
- Try a different model from the list

### Slow Responses
- Switch to faster models (haiku, flash)
- Check network connection
- Monitor 0Router logs for issues

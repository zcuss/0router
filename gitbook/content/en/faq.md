...
Common questions about 0Router.

---

## What is 0Router?

**0Router is an AI model router that maximizes your subscription value and minimizes costs.**
...
**0Router uses a 3-tier pricing strategy:**
...
**Yes, 0Router itself is 100% free and open source.**
...
**Yes! This is 0Router's core feature.**
...
**0Router tracks quota in real-time for all providers:**
...
## Can I self-host 0Router?

**Yes! 0Router supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.0Router`)
...
**Yes, 0Router prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.0Router` (or custom `DATA_DIR`)
- No data sent to 0Router servers
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/0Router/blob/main/CHANGELOG.md)
- Backup `~/.0Router` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/0Router/blob/main/CONTRIBUTING.md) for details.

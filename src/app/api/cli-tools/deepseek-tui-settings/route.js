...
// Build TOML config for 0Router (openai provider mode)
const build0RouterConfig = (baseUrl, apiKey, model) => {
...
// Detect 0Router by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = build0RouterConfig(baseUrl, apiKey || "sk_0Router", model);

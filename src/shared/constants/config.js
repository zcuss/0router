...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/decolua/0Router/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://0Router.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "0Router",
  installCmd: "npm i -g 0Router",
  installCmdLatest: "npm i -g 0Router@latest --prefer-online",
